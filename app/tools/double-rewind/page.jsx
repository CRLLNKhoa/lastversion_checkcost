...
import OutputDB from "@/components/layouts/output-db";
import OutputDBDefault from "@/components/layouts/output-db-default";

function DoubleRWPage() {
  ...
  return (
    <div className="bg-white p-4 rounded-lg grid lg:grid-cols-2">
      ...
      <div className="lg:pl-4 border-t lg:border-t-0 pt-4 lg:pt-0 mt-12 lg:mt-0">
        {typeResult === 0 ? (
          <OutputDBDefault data={result} />
        ) : (
          <OutputDB data={resultNew} />
        )}
      </div>
    </div>
  );
